...
class RoleController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        return redirect("panel/role")->with("success","Role succesfully created");
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        $save->save();
        PermissionRoleModel::InsertUpdateRecord($request->permission_id,$save->id);
        return redirect("panel/role")->with("success","Role succesfully updated");
    }
    public function delete($id)
    {
        ...
        $save=RoleModel::getSingle($id);
        $save->delete();
        return redirect("panel/role")->with("success","Role succesfully deleted"); 
    }
}
